...
function HomeComponent() {
    ...
    let handleJoinVideoCall = async () => {
        if (!meetingCode.trim()) return; // Empty code check
    ...
    return (
        <div style={{ backgroundColor: WHITE, minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "'Inter', sans-serif" }}>
            ...
            <motion.nav 
                ...
                style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 50px", borderBottom: `1px solid ${PRIMARY_BURGUNDY}20` }}
            >
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 10vw" }}>
                
                {/* Left Side: Join Meeting Form */}
                <motion.div 
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: "15px", alignItems: "center", flexWrap: "wrap" }}>
                        <input 
                            ...
                            onFocus={(e) => e.target.style.border = `2px solid ${PRIMARY_BURGUNDY}`}
                            onBlur={(e) => e.target.style.border = `2px solid ${PRIMARY_BURGUNDY}40`}
                ...
                {/* Right Side: Animated Abstract Workspace Graphic */}
                <motion.div 
                    initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.4 }}
                    style={{ flex: 1, display: "flex", justifyContent: "flex-end", position: "relative", height: "400px", alignItems: "center" }}
                >
                    <div style={{ position: "relative", width: "350px", height: "350px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                        ...
                        {[1, 2, 3].map((ring) => (
                            <motion.div
                                ...
                                style={{
                                    ...
                                    width: `${ring * 100}px`,
                                    height: `${ring * 100}px`,
                                    border: `1px solid ${PRIMARY_BURGUNDY}`,
                                    borderRadius: "50%",
                                }}
                            />
                        ))}
                        ...
                        <motion.div 
                            ...
                            style={{ position: "absolute", top: "20px", left: "20px", padding: "10px 15px", backgroundColor: WHITE, borderRadius: "8px", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.1)", border: `1px solid ${PRIMARY_BURGUNDY}20`, display: "flex", alignItems: "center", gap: "10px" }}
                        >
                        ...
                        <motion.div 
                            animate={{ y: [10, -10, 10] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                            style={{ position: "absolute", bottom: "40px", right: "-20px", padding: "10px 15px", backgroundColor: WHITE, borderRadius: "8px", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.1)", border: `1px solid ${PRIMARY_BURGUNDY}20`, display: "flex", alignItems: "center", gap: "10px" }}
                        >
